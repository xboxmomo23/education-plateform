 ...
 */
router.get('/me/grades/summary', auth_middleware_1.authenticate, (0, auth_middleware_1.authorize)('student'), (0, express_validator_1.query)('academicYear').optional().isInt({ min: 2020, max: 2100 }), (0, express_validator_1.query)('termId').optional().isUUID(), validation_middleware_1.validateRequest, report_controller_1.getStudentGradesSummaryHandler);
/**
 ...
 */
router.get('/:studentId/grades/summary', auth_middleware_1.authenticate, (0, express_validator_1.param)('studentId').isUUID(), (0, express_validator_1.query)('academicYear').optional().isInt({ min: 2020, max: 2100 }), (0, express_validator_1.query)('termId').optional().isUUID(), validation_middleware_1.validateRequest, async (req, res) => {
    ...
    if (req.user?.role === 'parent') {
        try {
            await (0, parent_model_1.assertParentCanAccessStudent)(req.user.userId, req.params.studentId, {
    ...
    try {
        ...
        let termInfo = null;
        if (termId) {
            termInfo = await findTermById(termId, establishmentId);
        }
      ...
      `;
        ...
        const generateAppreciation = (avg) => {
            if (avg >= 16)
 ...
 * Accès : admin, staff, parent (de l'élève), ou l'élève lui-même
 */
router.get('/:studentId/report', auth_middleware_1.authenticate, (0, express_validator_1.param)('studentId').isUUID(), (0, express_validator_1.query)('termId').isUUID().withMessage('termId est requis'), validation_middleware_1.validateRequest, report_controller_1.getStudentReportHandler);
/**
 ...
 * Accès : admin, staff, parent (de l'élève), ou l'élève lui-même
 */
router.get('/:studentId/report/data', auth_middleware_1.authenticate, (0, express_validator_1.param)('studentId').isUUID(), (0, express_validator_1.query)('termId').isUUID().withMessage('termId est requis'), validation_middleware_1.validateRequest, report_controller_1.getStudentReportDataHandler);
