...
async function upsertUser(params) {
    const passwordHash = await (0, auth_utils_1.hashPassword)(params.password);
...
async function ensureStudentData(studentUser) {
...
async function ensureParentData(parentUser) {
    await database_1.pool.query(`
...
async function ensureLink(studentId, parentId) {
    await database_1.pool.query(`
...
main();
//# sourceMappingURL=create-parent-test-data.js.map