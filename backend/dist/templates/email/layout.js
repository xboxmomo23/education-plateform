...
function renderEmailLayout({ title, greeting, messageLines, actionLabel, actionUrl, footerLines = [], }) {
...
const paragraphStyle = "font-size:15px;line-height:24px;color:#1f2937;margin:8px 0;";
...
const linkStyle = "display:block;padding:12px;background-color:#f8fafc;border-radius:6px;font-size:12px;color:#334155;word-break:break-all;text-decoration:none;margin:8px 0;";
const buttonStyle = "display:inline-block;padding:14px 32px;background:#2b62ff;color:#fff;text-decoration:none;border-radius:999px;font-weight:600;font-size:15px;";
